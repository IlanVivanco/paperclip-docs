...
Open **Connectors**, find **Grok**, and select **Connect**. Paperclip offers exactly the paths below; no other setup path is supported.

### Grok subscription (`ai-subscription`)
