...
seo_description: Connect Miro's provider-hosted MCP server. Set it up in Paperclip with browser sign-in, then choose which agents and actions are allowed.
---

# Miro

Connect Miro's provider-hosted MCP server.
