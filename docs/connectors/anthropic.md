...
seo_description: Use Anthropic APIs with a restricted key. Set it up in Paperclip with a subscription or API key, then choose which agents and actions are allowed.
---
