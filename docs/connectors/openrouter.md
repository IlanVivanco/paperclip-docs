...
seo_description: Connect OpenRouter accounts for your agents. Set it up in Paperclip with a subscription or API key, then choose which agents and actions are allowed.
---

# OpenRouter

Connect OpenRouter accounts for your agents.
