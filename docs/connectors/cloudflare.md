...
seo_description: DNS, CDN, and edge compute. Agents work with the account your Cloudflare sign-in can reach, under per-action permissions you set in Paperclip.
---

# Cloudflare

DNS, CDN, and edge compute. Agents work with the account your Cloudflare sign-in can reach.

## What this connector does

Cloudflare is an **app integration**: it gives agents actions to call. Once it is connected, the provider's server supplies the action list, and Paperclip governs which agents may call which of those actions.
